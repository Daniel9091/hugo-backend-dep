"""
Django settings for hugo_api project.
...
# DEBUG = os.getenv('DEBUG')                                                    # DEPLOYMENT
DEBUG = False
...
WSGI_APPLICATION = 'hugo_api.wsgi.application'
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')                         # DEPOLOYMENT
